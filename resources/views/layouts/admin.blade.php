  ...
  <aside class="w-full md:w-64 bg-gradient-to-b from-blue-800 to-blue-900 text-white flex flex-col">
    <nav class="flex-1 px-4 py-6 space-y-2">
     <nav class="flex-1 space-y-4">
        <a href="{{ route('admin.beranda') }}" class="flex items-center gap-3 hover:bg-blue-700 p-2 rounded-md transition">
            <img src="https://img.icons8.com/fluency/48/home.png" alt="Home" class="w-6 h-6">
            <span class="text-base">Beranda</span>
        </a>
        <a href="{{ route('admin.warga.index') }}" class="flex items-center gap-3 hover:bg-blue-700 p-2 rounded-md transition">
            <img src="https://img.icons8.com/3d-fluency/94/group--v1.png" alt="Data Warga" class="w-6 h-6">
            <span class="text-base">Data Warga</span>
        </a>
        <a href="{{ route('admin.kartukeluarga.index') }}" class="flex items-center gap-3 hover:bg-blue-700 p-2 rounded-md transition">
      ...
      <p class="text-sm font-semibold mt-4 border-t border-blue-500 pt-2">KELOLA DATA</p>
      <a href="{{ route('admin.perpindahan.index') }}" class="block ml-2 hover:text-blue-300">• PERPINDAHAN</a>
      <a href="{{ route('admin.pendatang.index') }}" class="block ml-2 hover:text-blue-300">• PENDATANG BARU</a>
      <a href="{{ route('admin.kelahiran.index') }}" class="block ml-2 hover:text-blue-300">• KELAHIRAN</a>
      <a href="{{ route('admin.kematian.index') }}" class="block ml-2 hover:text-blue-300">• KEMATIAN</a>
    </nav>
